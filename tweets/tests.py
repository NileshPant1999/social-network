...
class TweetTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username= "nilesh", password = 'somepassword')
        self.userb = User.objects.create_user(username='nilesh2', password='anypassword')
    ...
    def test_user_created(self):
        ...
        self.assertEqual(self.user.username,"nilesh")
